...
def generate_simulation_trials(args):
	...
	trial_combinations = []
	i = 0
	for (r_to_g_config, num_turns, start_direction, assistance_type, start_mode, ui_given_a_noise, um_given_ui_noise, entropy_threshold) in itertools.product(RG_CONFIGS, NUM_TURNS, START_DIRECTION, ASSISTANCE_TYPE, START_MODE, UI_GIVEN_A_NOISE, UM_GIVEN_UI_NOISE, ENTROPY_THRESHOLD):
